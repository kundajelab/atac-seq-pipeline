...
# ENCODE DCC SEACR call peak wrapper
...
def parse_arguments():
    parser = argparse.ArgumentParser(prog='ENCODE SEACR callpeak',
                                     description='')
    parser.add_argument(
        'tas', type=str, nargs='+',
...
def seacr(ta, ctl_ta, chrsz, gensz, pval_thresh, smooth_win, cap_num_peak,
          out_dir):
